...
# Judul Dashboard
st.title("🌦️ Prediksi Iklim Sumatera Selatan dengan Machine Learning")
st.write("Dashboard otomatis membaca dataset tanpa perlu upload file.")
...
try:
    ...
    st.success(f"Dataset berhasil dimuat: {FILE_NAME}")
except:
    st.error(f"❌ File `{FILE_NAME}` tidak ditemukan. Pastikan file ada di folder yang sama.")
    st.stop()

# ============= HANDLE DUPLIKAT KECEPATAN ANGIN =============
